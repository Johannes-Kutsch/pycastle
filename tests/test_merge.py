...
def test_merge_phase_recreates_preserved_merge_sandbox_from_current_safe_sha(
    conflicting_repo, github_svc
):
    """A preserved failed merge-sandbox must not resume from its obsolete branch tip."""
    ...
    sandbox_path = (
        conflicting_repo
        / Config(pycastle_dir=".pycastle").pycastle_dir
        / ".worktrees"
        / "merge-sandbox"
    )
    _git(
