...
- [0058 — Host-owned issue filing](0058-host-owned-issue-filing.md): Two-stage commit (create without state label, then apply label); blocking as body text and native dependencies; fail-fast-with-a-durable-record via `_candidate_record`.
