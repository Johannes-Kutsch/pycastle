...
implement_override = StageOverride(service="claude", model="sonnet", effort="medium")
...
preflight_issue_override = StageOverride(service="claude", model="opus", effort="high")
