...
**Amendment (ADR 0055):** The "kept for `HardAgentError` and non-OpenCode `AgentCredentialFailureError`" exception noted above has since been removed. See ADR 0055 — agents never cancel siblings on any error.
