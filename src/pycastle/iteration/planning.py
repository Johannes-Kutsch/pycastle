...
from ._utils import BODY_FLOOR, is_well_formed_body as _is_well_formed_body

is_well_formed_body = _is_well_formed_body
...
def partition_by_slice_label(
    ...
    malformed: list[dict] = []
    for issue in issues:
        if isinstance(classify_issue_readiness(issue, cfg).slice_status, WellFormed):
