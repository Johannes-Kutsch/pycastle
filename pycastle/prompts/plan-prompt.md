...
For each unblocked issue, assign a branch name using the format `pycastle/issue-{number}-{slug}`.
...
<plan>
{"issues": [{"number": 42, "title": "Fix auth bug", "branch": "pycastle/issue-42-fix-auth-bug"}]}
</plan>
