...
{floor} characters after stripping whitespace).
...
def _sync_needs_info(
    ...
    for issue in malformed_body:
        ...
        github_svc.post_comment(
            issue["number"],
            _NEEDS_INFO_COMMENT.format(floor=BODY_FLOOR),
        )
...
async def planning_phase(
    ...
    async with status_row(
        ...
        good_body = [i for i in open_issues if is_well_formed_body(i)]
        bad_body = [i for i in open_issues if not is_well_formed_body(i)]
