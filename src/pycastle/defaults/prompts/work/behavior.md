...
**Gate rule — the first `<behavior>` tag opens production code:**
...
Refactoring is not part of this session — it belongs to the review stage. When the last behavior is green and every prose artifact from *Explore* is edited, you are done.
